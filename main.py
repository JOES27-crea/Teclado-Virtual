# Ciclo principal del sistema: captura video, detecta gestos y actualiza la interfaz
# Coordina la interacción entre los módulos de detección, lógica y visualización
import os
...
import pygame  
import cv2  
from interfaz_teclado import KeyboardUI  
from detector_manos import HandTracker  
